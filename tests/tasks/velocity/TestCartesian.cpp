...
protected:
                                 ...
                                 std::string(OPENSOT_TESTS_ROBOTS_DIR)+"coman/coman.srdf")
    {
        ...
        _model_ptr = std::static_pointer_cast<XBot::ModelInterfaceIDYNUTILS>
...
//    EXPECT_TRUE(cartesian.getb() == conversion_utils_YARP::toEigen(cartesian.getLambda()*cat(positionError, -orientationErrorGain*orientationError)));
