...
//    Eigen::MatrixXd T_init = idynutils.iDyn3_model.getPosition(
...
//    Eigen::MatrixXd T = idynutils.iDyn3_model.getPosition(
//                idynutils.iDyn3_model.getLinkIndex("Waist"),
//                idynutils.iDyn3_model.getLinkIndex(ee));
...
//{
//    int n_dofs = 5;
//    Eigen::VectorXd q(n_dofs, 0.0);
//    Eigen::VectorXd q_ref(q.size(), M_PI);

//    Eigen::VectorXd q2(n_dofs, 0.0);
//    Eigen::VectorXd q_ref2(q2.size(), M_PI);
...
//        Eigen::VectorXd _dq2 = cartesian_utils::fromEigentoYarp(dq2);
//        q2 += _dq2;
//    }
...
//                        std::string(OPENSOT_TESTS_ROBOTS_DIR)+"coman/coman.urdf",
//                        std::string(OPENSOT_TESTS_ROBOTS_DIR)+"coman/coman.srdf");
//    Eigen::VectorXd q(idynutils.iDyn3_model.getNrOfDOFs(), 0.0);
//    Eigen::VectorXd leg(idynutils.left_leg.getNrOfDOFs(), 0.0);
...
//        EXPECT_TRUE(sot.solve(dq));
//        Eigen::VectorXd dq_ = cartesian_utils::fromEigentoYarp(dq);
//        q += dq_;
//    }
