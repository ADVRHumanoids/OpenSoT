...
static const double                     SOT_DEFAULT_MAX_COM_VELOCITY_BOUNDS(0.05);
...
static const paramHelp::ParamBilatBounds<double> SOT_MAX_COM_VELOCITY_BOUNDS(ParamBilatBounds<double>(0,1.0));
...
new ParamProxyBasic<double>("max_CoM_velocity",                    PARAM_ID_MAX_COM_VELOCITY,                    1,        &SOT_MAX_COM_VELOCITY_BOUNDS,          PARAM_IN_OUT,     &SOT_DEFAULT_MAX_COM_VELOCITY_BOUNDS,                    "Maximum velocity [m/sec] for the CoM"),
