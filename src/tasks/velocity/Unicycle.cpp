 ...
 * Author: Juan Alejandro Castano, Enrico Mingo Hoffman
	...
	)
{
	...
	_constA(2,1)=1*0;    //just motion in X /// By using this option, the Y direction also can rotate to dicipate energy if t
