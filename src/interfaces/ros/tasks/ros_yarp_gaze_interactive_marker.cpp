...
{
public:
    GazeMarker(const std::string& base_link, const std::string& distal_link, const std::string& server_name,
...
//              _port.write();
    ...
    void makeGazeMarker( bool fixed, const tf::StampedTransform& T, const std::string& base_link,  const std::string& distal_link, bool show_gaze )
    {
      ...
      _menu_handler.insert( "Reset pose", boost::bind(&GazeMarker::processFeedback, this, _1) );
      ...
      server->setCallback(int_marker.name, boost::bind(&GazeMarker::processFeedback, this, _1));
...
{
    ros::init(argc, argv, "gaze_marker");
    ros::NodeHandle n("~");
    ...
    GazeMarker marker(base_link, distal_link, node_name, port_name, yarp_network);
