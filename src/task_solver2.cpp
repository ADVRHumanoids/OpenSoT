                                    ...
                                    const double velocity_bounds_scale)
{
    ...
    if(result0)
    {
        ...
        if(!qp1.isQProblemInitialized())
            result1 = qp1.initProblem(H1, g1, A1, lA1, uA1, l1, u1);
        else
        {
            qp1.updateProblem(H1, g1, A1, lA1, uA1, l1, u1);
            result1 = qp1.solve();
        }
        if(result1)
        {
        ...
        {
            ROS_ERROR("ERROR OPTIMIZING POSTURE TASK");
            return false;
        }
    }
    else
    {
        ROS_ERROR("ERROR OPTIMIZING CARTESIAN TASK");
        return false;
    }
}
